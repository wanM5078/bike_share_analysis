...
* RStudio (using R as it's free and can handle large dataset with ease (1.11 GB, with almost 6 millions row of data in 18 columns). Cleaning, analysis and visualization can all be done in a single platform)
